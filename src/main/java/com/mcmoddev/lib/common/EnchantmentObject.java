 ...
 * {@link net.minecraft.enchantment.EnchantmentData} however the level is not final, and it can be written to and read
 * from byte buffers.
 *
...
public class EnchantmentObject {
     ...
     *
     * @param buf
     *         The buffer of bytes to read from.
     */
     ...
     *
     * @param buf
     *         The buffer of bytes to write to.
     */
