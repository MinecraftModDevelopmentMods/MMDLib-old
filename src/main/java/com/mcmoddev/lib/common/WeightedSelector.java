...
/**
 * Provides an all in one solution to weighted systems. Weighted randomization is fairly
 * simple. Rather than providing a percentage per entry, each entry is given a weight. The
