...
/**
 * A collection of useful methods for working with banners. Includes methods for creating new
 * banner patterns, and creating new ItemStacks.
 *
...
public final class BannerUtils {
    ...
    /**
     * Creates a new banner ItemStack that has predefined banner layers on it.
     *
    ...
    /**
     * A simple type to represent the layers of a banner.
     *
     * @author Tyler Hancock (Darkhax)
     */
