...
/**
 * A collection of miscellaneous utilities for working with players.
 * 
...
public final class PlayerUtils {
    ...
    public static String getPlayerNameFromUUID (UUID uuid) {
        ...
        try {
            ...
            MMDLib.LOG.warn("Could not get name for " + uuid + " " + exception.getMessage());
    ...
    public static UUID getUUIDFromName (String username) {
        ...
        try {
            ...
            MMDLib.LOG.warn("Could not get name for " + username + " " + exception.getMessage());
        }
        return uuid;
    }
