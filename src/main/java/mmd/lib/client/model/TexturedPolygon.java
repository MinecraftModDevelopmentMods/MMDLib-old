	...
	public void draw(Tessellator tessellator, float f)
    {
        ...
        if(iNormals.size() == 0)
        {
	        ...
	        if(vertexPositions.length >= 3)
	        {
		        ...
		        net.minecraft.util.math.Vec3d Vec3d1 = vertexPositions[1].vector3D.subtract(vertexPositions[2].vector3D);
		        net.minecraft.util.math.Vec3d Vec3d2 = Vec3d1.crossProduct(Vec3d).normalize();
